...
CREATE TABLE IF NOT EXISTS `character_tool_configs` (`characterId` TEXT NOT NULL, `payloadJson` TEXT NOT NULL, `updatedAt` TEXT NOT NULL, PRIMARY KEY(`characterId`), FOREIGN KEY(`characterId`) REFERENCES `characters`(`id`) ON UPDATE NO ACTION ON DELETE CASCADE );
...
CREATE TABLE IF NOT EXISTS `story_preset_state` (`singletonId` INTEGER NOT NULL, `activePresetId` TEXT NOT NULL, PRIMARY KEY(`singletonId`));

CREATE TABLE IF NOT EXISTS `story_preset_library_groups` (`id` TEXT NOT NULL, `name` TEXT NOT NULL, `sortIndex` INTEGER NOT NULL, PRIMARY KEY(`id`));

CREATE TABLE IF NOT EXISTS `story_presets` (`id` TEXT NOT NULL, `name` TEXT NOT NULL, `modelFamily` TEXT NOT NULL, `modelTagsJson` TEXT NOT NULL DEFAULT '[]', `libraryGroupId` TEXT NOT NULL DEFAULT 'story-preset-group-default', `activeVersionId` TEXT NOT NULL DEFAULT '', `authorName` TEXT NOT NULL DEFAULT '', `authorAvatarPath` TEXT NOT NULL DEFAULT '', `authorTagsJson` TEXT NOT NULL DEFAULT '[]', `description` TEXT NOT NULL DEFAULT '', `sortIndex` INTEGER NOT NULL, `expandedGroupIdsJson` TEXT NOT NULL, PRIMARY KEY(`id`));

CREATE TABLE IF NOT EXISTS `story_preset_contents` (`presetId` TEXT NOT NULL, `kind` TEXT NOT NULL, `content` TEXT NOT NULL, PRIMARY KEY(`presetId`, `kind`), FOREIGN KEY(`presetId`) REFERENCES `story_presets`(`id`) ON UPDATE NO ACTION ON DELETE CASCADE );

CREATE INDEX IF NOT EXISTS `index_story_preset_contents_presetId` ON `story_preset_contents` (`presetId`);

CREATE TABLE IF NOT EXISTS `story_preset_entries` (`presetId` TEXT NOT NULL, `entryId` TEXT NOT NULL, `sortIndex` INTEGER NOT NULL, `payloadJson` TEXT NOT NULL, PRIMARY KEY(`presetId`, `entryId`), FOREIGN KEY(`presetId`) REFERENCES `story_presets`(`id`) ON UPDATE NO ACTION ON DELETE CASCADE );

CREATE INDEX IF NOT EXISTS `index_story_preset_entries_presetId` ON `story_preset_entries` (`presetId`);

CREATE TABLE IF NOT EXISTS `story_preset_groups` (`presetId` TEXT NOT NULL, `groupId` TEXT NOT NULL, `sortIndex` INTEGER NOT NULL, `payloadJson` TEXT NOT NULL, PRIMARY KEY(`presetId`, `groupId`), FOREIGN KEY(`presetId`) REFERENCES `story_presets`(`id`) ON UPDATE NO ACTION ON DELETE CASCADE );

CREATE INDEX IF NOT EXISTS `index_story_preset_groups_presetId` ON `story_preset_groups` (`presetId`);

CREATE TABLE IF NOT EXISTS `story_preset_runtime_entries` (`presetId` TEXT NOT NULL, `slot` TEXT NOT NULL, `contentOverride` TEXT NOT NULL, `enabled` INTEGER NOT NULL, PRIMARY KEY(`presetId`, `slot`), FOREIGN KEY(`presetId`) REFERENCES `story_presets`(`id`) ON UPDATE NO ACTION ON DELETE CASCADE );

CREATE INDEX IF NOT EXISTS `index_story_preset_runtime_entries_presetId` ON `story_preset_runtime_entries` (`presetId`);

CREATE TABLE IF NOT EXISTS `story_preset_versions` (`presetId` TEXT NOT NULL, `versionId` TEXT NOT NULL, `versionNumber` INTEGER NOT NULL, `name` TEXT NOT NULL DEFAULT '', `createdAtEpochMs` INTEGER NOT NULL, `expandedGroupIdsJson` TEXT NOT NULL, PRIMARY KEY(`presetId`, `versionId`), FOREIGN KEY(`presetId`) REFERENCES `story_presets`(`id`) ON UPDATE NO ACTION ON DELETE CASCADE );

CREATE INDEX IF NOT EXISTS `index_story_preset_versions_presetId` ON `story_preset_versions` (`presetId`);

CREATE TABLE IF NOT EXISTS `story_preset_version_contents` (`presetId` TEXT NOT NULL, `versionId` TEXT NOT NULL, `kind` TEXT NOT NULL, `content` TEXT NOT NULL, PRIMARY KEY(`presetId`, `versionId`, `kind`), FOREIGN KEY(`presetId`, `versionId`) REFERENCES `story_preset_versions`(`presetId`, `versionId`) ON UPDATE NO ACTION ON DELETE CASCADE );

CREATE INDEX IF NOT EXISTS `index_story_preset_version_contents_presetId_versionId` ON `story_preset_version_contents` (`presetId`, `versionId`);

CREATE TABLE IF NOT EXISTS `story_preset_version_entries` (`presetId` TEXT NOT NULL, `versionId` TEXT NOT NULL, `entryId` TEXT NOT NULL, `sortIndex` INTEGER NOT NULL, `payloadJson` TEXT NOT NULL, PRIMARY KEY(`presetId`, `versionId`, `entryId`), FOREIGN KEY(`presetId`, `versionId`) REFERENCES `story_preset_versions`(`presetId`, `versionId`) ON UPDATE NO ACTION ON DELETE CASCADE );

CREATE INDEX IF NOT EXISTS `index_story_preset_version_entries_presetId_versionId` ON `story_preset_version_entries` (`presetId`, `versionId`);

CREATE TABLE IF NOT EXISTS `story_preset_version_groups` (`presetId` TEXT NOT NULL, `versionId` TEXT NOT NULL, `groupId` TEXT NOT NULL, `sortIndex` INTEGER NOT NULL, `payloadJson` TEXT NOT NULL, PRIMARY KEY(`presetId`, `versionId`, `groupId`), FOREIGN KEY(`presetId`, `versionId`) REFERENCES `story_preset_versions`(`presetId`, `versionId`) ON UPDATE NO ACTION ON DELETE CASCADE );

CREATE INDEX IF NOT EXISTS `index_story_preset_version_groups_presetId_versionId` ON `story_preset_version_groups` (`presetId`, `versionId`);

CREATE TABLE IF NOT EXISTS `story_preset_version_runtime_entries` (`presetId` TEXT NOT NULL, `versionId` TEXT NOT NULL, `slot` TEXT NOT NULL, `contentOverride` TEXT NOT NULL, `enabled` INTEGER NOT NULL, PRIMARY KEY(`presetId`, `versionId`, `slot`), FOREIGN KEY(`presetId`, `versionId`) REFERENCES `story_preset_versions`(`presetId`, `versionId`) ON UPDATE NO ACTION ON DELETE CASCADE );

CREATE INDEX IF NOT EXISTS `index_story_preset_version_runtime_entries_presetId_versionId` ON `story_preset_version_runtime_entries` (`presetId`, `versionId`);
