...
object AuthorApiCatalog {
    val definitions: List<AuthorApiDefinition> = listOf(
        ...
        definition("messages.edit", "messages", "直接保存一条非系统消息，不触发生成", AuthorApiPermission.MessagesWrite),
        ...
        definition("appearance.getChatBackground", "appearance", "读取当前聊天背景", AuthorApiPermission.AppearanceRead),
        definition("appearance.openChatBackgroundSettings", "appearance", "打开聊天背景设置", AuthorApiPermission.AppearanceWrite),
